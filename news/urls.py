...
urlpatterns = patterns('',
    ...
    url(r'^event/(?P<event_id>\d+)/publish$', views.publish_event, name='publish_event'),
    ...
    url(r'^content/(?P<content_id>\d+)/publish$', views.publish_content, name='publish_content'),
